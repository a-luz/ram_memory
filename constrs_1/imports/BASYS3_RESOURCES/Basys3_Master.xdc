...
#set_property PACKAGE_PIN W15 [get_ports {dutycycle[4]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {dutycycle[4]}]
#set_property PACKAGE_PIN V15 [get_ports {dutycycle[5]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {dutycycle[5]}]
#set_property PACKAGE_PIN W14 [get_ports {dutycycle[6]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {dutycycle[6]}]
set_property PACKAGE_PIN W13 [get_ports {we_in}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {we_in}]
...
set_property PACKAGE_PIN U1 [get_ports {addr_in[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {addr_in[0]}]
set_property PACKAGE_PIN T1 [get_ports {addr_in[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {addr_in[1]}]
set_property PACKAGE_PIN R2 [get_ports {addr_in[2]}]					
